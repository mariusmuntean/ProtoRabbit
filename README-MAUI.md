...
|                                                                                                             |                                                                                                                  |                                                                                                                         |
| :---------------------------------------------------------------------------------------------------------: | :--------------------------------------------------------------------------------------------------------------: | :---------------------------------------------------------------------------------------------------------------------: |
| <img src="Images/MAUI/MainView macOS.png" alt="Main Windows macOS" width="70%" title="Main Windows macOS"/> | <img src="Images/MAUI/MainView Windows.png" alt="Main Window Windows" width="70%" title="Main Windows Windows"/> | <img src="Images/MAUI/SubscriptionView.png" alt="New Subscription macOS" width="100%" title="New Subscription macOS" /> |
